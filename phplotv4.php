...
//exit;
	...
	function SetEqualXCoord() {
		//for plots that have equally spaced x privateiables and multiple bars per x-point.
  ...
  //I think that eventually this space privateiable will be replaced by just graphing x.
